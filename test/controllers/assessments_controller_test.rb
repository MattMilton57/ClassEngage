...
class AssessmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post assessments_url, params: { assessment: { participating: @assessment.participating } }, as: :json
    end
  ...
  test "should update assessment" do
    patch assessment_url(@assessment), params: { assessment: { participating: @assessment.participating } }, as: :json
    assert_response 200
  end
